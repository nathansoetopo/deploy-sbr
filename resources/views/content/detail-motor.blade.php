...
@section('content')
  ...
  <!--</div>-->
    ...
    <div class="products" style="margin-top:0px; padding-top:150px; background-color:white;">
      <div class="container">
        <div class="row">
          <div class="col-md-6">
              <center>
            ...
            <div class="row" style="justify-content: center; margin-bottom: 100px;">
              @foreach($data->warna as $w)
                <div style="margin-bottom:10px;" class="col-2 col-md-2 col-lg-2">
                    <center>
                  <button class="btn" style="background-color: {{$w->kode}}" type="button" onclick="getValue({{$w->id}}, {{$data->id}})"></button>
                  </center>
                </div>
              ...
              @endforeach
                ...
                <center>
                  ...
                  <p style="font-weight:700; font-size:20px;">{{ $motors->nama_produk }}</p>
                                @foreach($motors->harga as $h)
                                    <h6 style="font-weight:700; font-size:20px;">{{ $h->harga }}</h6>
                                    <p style="font-weight:400; color:grey; margin-bottom:10px;">Harga Rekomendasi OTR {{ $h->plat }} </p>
                                @endforeach
                    ...
                    <div class="col-md-6" >
            <img style="border-radius:15px; width:100%; margin-bottom:20px;" src="{{ asset($motors->gambar_tabel) }}">
            </div>

            <div class="col-md-12" >
            <img style="border-radius:15px; width:100%; margin-bottom:20px;" src="{{ asset($motors->gambar_spek) }}">
            </div>
