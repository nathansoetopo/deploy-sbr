...
<div class="page-heading about-heading header-text"
    style="background-image: url({{ asset('assets/images/heading-6-1920x500.jpg') }});">
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="row">
                    ...
                    <div class="col-md-4">
                        <div class="service-item">
                            <a href="{{ url('artikel/'.$a->slug.'') }}" class="services-item-image"><img
                                    src="{{ asset(''.$a->gambar.'') }}" class="img-fluid" alt=""></a>
