      ...
      <div class="row">
        ...
        <div class="col-md-6">
          <div class="left-content">
            <p>Dealer Resmi Yamaha Sumber Baru Rejeki yang tersebar di 27 cabang se-Jawa Tengah, Jawa Timur dan Yogyakarta.</p>
...
<img style="width: 100%; height:auto;" src="{{ asset('assets/images/testi1.jpeg') }}" alt="yamaha di solo">
            ...
            <div class="service-item">
              <div class="">
                <img style="width: 100%; height:auto;" src="{{ asset('assets/images/testi6.jpeg') }}" alt="yamaha di solo">
              </div>
              <div class="down-content">
                <h4>Testimonial</h4>
                <!--<p class="n-m"><em>"Motor disini sangat bagus, harganya juga lebih murah dari dealer lain"</em></p>-->
              </div>
            </div>
          </div>
        </div>
